...
# --- KONFIGURASI JUMLAH HALAMAN ---
# Mengambil jumlah halaman dari argumen pertama.
# Jika tidak ada argumen, default-nya adalah 100.
PAGE_COUNT=${1:-100}
...
echo "Memulai pembuatan $PAGE_COUNT halaman HTML..."

# Loop untuk generate sesuai jumlah PAGE_COUNT
...
echo ""
echo "========================================="
echo "Selesai! Total $PAGE_COUNT file HTML dibuat."
echo "Root: ${ROOT_DIR}"
